...
electricalEngineer::electricalEngineer(const electricalEngineer& inp_engineer)
    : engineer(inp_engineer),specialization(inp_engineer.get_specialization()){
        std::cout << "Custom copy constructor called for electrical engineer..." << std::endl;
}

std::string electricalEngineer::get_specialization() const{
